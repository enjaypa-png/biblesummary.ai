...
Quick reference for AI assistants working on BibleSummary.ai.

## Project Overview

BibleSummary.ai is a Bible reading companion built with Next.js 14 (App Router). It serves two translations (Clear Text and KJV), verse-by-verse text-to-speech audio, AI explanations, notes, highlights, bookmarks, and paid book summaries.
