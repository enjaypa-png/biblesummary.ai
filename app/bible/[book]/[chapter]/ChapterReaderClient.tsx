          ...
          {verses.map((verse: Verse) => {
            ...
            return (
              <span key={verse.id}>
                ...
                {/* Unified Action Bar - appears when verse is active */}
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        ...
                        className="flex flex-col items-center justify-center px-4 py-2.5 text-white hover:bg-white/10 active:bg-white/20 transition-colors"
                      ...
                      >
                        ...
                        <span className="text-[10px] font-medium mt-1">Explain</span>
                      </button>

                      {/* Divider */}
                      <span className="w-px bg-white/20 my-2" />

                      {/* Highlight - DISABLED */}
                      <button
                        disabled
                        className="flex flex-col items-center justify-center px-4 py-2.5 text-white/40 cursor-not-allowed"
                        title="Coming soon"
                      >
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <span className="text-[10px] font-medium mt-1">Highlight</span>
                      </button>
                      ...
                      >
                        ...
                        <span className="text-[10px] font-medium mt-1">Bookmark</span>
                      </button>
                      ...
                      >
                        ...
                        <span className="text-[10px] font-medium mt-1">Note</span>
                      </button>
