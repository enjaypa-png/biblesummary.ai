...
- The CT is a modern English rendering of the entire Bible generated by Claude Opus 4.6.
- **Audit status:** Genesis, Exodus, Leviticus, Numbers, Deuteronomy, Joshua, and Judges have been audited against the KJV. Corrections were applied and the master prompt was strengthened after each audit. Ruth–Revelation is generated but not yet audited. User-facing labels call it "Clear Text" and note "Under Review."
...
- **Core rule:** Modernize grammar and archaic vocabulary, but preserve every KJV noun, creature name, and specific term. If the KJV says "osprey," keep "osprey." If it says "abomination," keep "abomination."
- **Protected terms** must be preserved exactly: heaven/heavens, created, made, soul, spirit, grace, righteousness, salvation, covenant, sin, atonement, glory, faith, mercy, God, LORD, Lord GOD, the Almighty, Christ, Holy Spirit, angel/angels, abomination, unicorn, Ethiopian, leprous/leprosy, heave offering, high places, water of separation, fiery serpent, badgers' skins, tabernacle of the congregation, princes, solemn assembly, firstfruits, images, estimation, breach, jealous/jealous God, testimonies, holy, inheritance, perfect, blessed, and all proper names, animal names, and KJV-specific nouns.
- **No additions or omissions.** Every phrase in the KJV must have a counterpart in the CT. Nothing is added, dropped, softened, or strengthened.
- **No interpretation.** "Hornet" stays "hornet," "circumcise the foreskin of your heart" stays intact, "jealous God" stays "jealous God." Translate literally, do not substitute your interpretation.
- **Preserve pronoun number.** If the KJV says "he," do not write "they." Singular and plural must match exactly.
- When the original repeats a word for emphasis, the CT preserves the repetition. Poetic contrasts (full/empty, light/darkness) are preserved.
- Tone target: clear and dignified at a 10th grade reading level. Not academic, not casual.
